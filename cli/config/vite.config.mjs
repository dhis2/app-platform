...
// This file is the config used by the CLI
console.log('I am the CLI config!')
...
export default defineConfig(({ mode, paths }) => {
    ...
    return {
        ...
        build: {
            ...
            rollupOptions: {
                input: {
                    // TODO: use path to shell index.html
                    main: paths
                        ? paths.shellIndexHtml
