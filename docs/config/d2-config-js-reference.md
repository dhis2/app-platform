...
|        **id**          |       _string_       |                   | The ID of the app on the [App Hub](https://apps.dhis2.org/). Used for uploading the app to the App Hub. See [this guide](https://developers.dhis2.org/docs/guides/publish-apphub/) for how to setup continuous delivery.     |
